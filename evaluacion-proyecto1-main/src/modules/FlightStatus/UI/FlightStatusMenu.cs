...
namespace SistemadeTiquetess.src.modules.FlightStatus.UI;

public class FlightStatusMenu
{
    private readonly IFlightStatusServices _services;
    public FlightStatusMenu(IFlightStatusServices services) => _services = services;
    ...
    public async Task ShowMenuAsync()
    {
        ...
        while (isRunning)
        {
            Console.Clear();
            Console.WriteLine("=========================================");
            Console.WriteLine("      Configuración de Estados Vuelo     ");
            Console.WriteLine("=========================================");
