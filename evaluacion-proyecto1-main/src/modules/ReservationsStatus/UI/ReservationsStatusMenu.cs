...
namespace SistemadeTiquetess.src.modules.ReservationsStatus.UI;

public class ReservationsStatusMenu
{
    private readonly IReservationsStatusServices _services;
    public ReservationsStatusMenu(IReservationsStatusServices services) => _services = services;
    ...
    public async Task ShowMenuAsync()
    {
        ...
        while (isRunning)
        {
            Console.Clear();
            Console.WriteLine("=========================================");
            Console.WriteLine("      Gestión de Estados de Reserva      ");
            Console.WriteLine("=========================================");
    ...
    private async Task CreateStatusAsync()
    {
        ...
        try {
            var status = ReservationStatus.Create(name);
